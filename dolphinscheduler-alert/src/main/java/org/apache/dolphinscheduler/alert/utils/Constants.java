...
public class Constants {
     ...
     * 二次开发新增常量  告警发送短信  ---开始---
     */
    public static final String PLUGIN_DEFAULT_SMS = "sms";
    public static final String PLUGIN_DEFAULT_SMS_CH = "短信";
    public static final String PLUGIN_DEFAULT_SMS_EN = "sms";
    /**
     * 二次开发新增常量  告警发送短信  ---结束---
     */
